...
class Utils:
    ...
    def get_latest_experiment() -> str|bool:
        try:
            with open('experiments.json', 'r', encoding='utf-8') as exps:
                latest_data = json.load(exps)
            
            return latest_data[-1] if latest_data else False
